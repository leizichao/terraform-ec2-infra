resource "aws_instance" "public" {
  ...
  subnet_id                   = "subnet-04d618bda963e4e02"  #Public Subnet ID, e.g. subnet-xxxxxxxxxxx
  associate_public_ip_address = true
  key_name                    = "zc-key-pair" #Change to your keyname, e.g. jazeel-key-pair
  vpc_security_group_ids = [aws_security_group.allow_ssh.id]
 
  tags = {
    Name = "zc-ec2-terraform"    #Prefix your own name, e.g. jazeel-ec2
  }
}
